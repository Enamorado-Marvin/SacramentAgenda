...
namespace SacramentAgenda.Controllers
{
    public class SpeakersController : Controller
    {
        ...
        public SpeakersController(UnitContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SpeakerName,Subject")] Speaker speaker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SpeakerID,SpeakerName,Subject")] Speaker speaker)
        {
